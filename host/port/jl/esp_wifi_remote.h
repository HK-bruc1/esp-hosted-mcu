/* host/port/jl/esp_wifi_remote.h
 * JL shadow of ESP-IDF esp_wifi_remote.h.
 *
 * Declares the esp_wifi_remote_* API implemented by host/api/src/esp_hosted_api.c
 * and provides JL-compatible type aliases for ESP-IDF Wi-Fi types.
 */

#ifndef JL_ESP_WIFI_REMOTE_H
#define JL_ESP_WIFI_REMOTE_H
...
/* Forward declaration; full struct is defined in host/api/src/esp_hosted_api.c. */
...
esp_err_t esp_wifi_remote_channel_set(wifi_interface_t ifx, void *channel, void *tx_fn);

#ifdef __cplusplus
}
#endif

#endif /* JL_ESP_WIFI_REMOTE_H */
